			...
			<div class="row">
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 col-md-offset-3">
					<div class=" main-content-area">
                        ...
                        <div style="padding-bottom: 20px" class="mb-4 text-sm text-gray-600">
                            <p>
							...
							<div class="login-form form-item form-stl">
                                ...
                                <input type="hidden" name="token" value="{{ $request->route('token') }}">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="forgetpass" name="email" placeholder="Type your email address" value="{{ $request->email }}" required autofocus>
									</fieldset>
                                    <fieldset class="wrap-input item-width-in-half left-item ">
										<label for="paswd">Password *</label>
										<input type="password" id="paswd" name="password" placeholder="Password" required autocomplete="new-password">
									</fieldset>
