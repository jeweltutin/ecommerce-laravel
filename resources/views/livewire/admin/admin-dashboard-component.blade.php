    ...
    <div class="row">
            ...
            <div class="card mb-3 widget-content bg-midnight-bloom">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        ...
                        <div class="widget-subheading">Total Orders from staring</div>
                    </div>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card mb-3 widget-content bg-arielle-smile">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading">Total Sale Today</div>
                        <div class="widget-subheading">Total Sale of the day</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white"><span>{{ $totalSalesToday }}</span></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-4">
            <div class="card mb-3 widget-content bg-grow-early">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading">Total Revenue Today</div>
                        <div class="widget-subheading">Total Revenue of the Day</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white"><span>৳ {{ $todayRevenue }}</span></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">{{ $order->firstname  }} {{ $order->lastname }}</div>
                                                <div class="widget-subheading opacity-7">Occupation
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @endif
                                <td class="text-center">
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.orderdetails', ['order_id' => $order->id]) }}"> Details</a>
                                </td>
                            </tr>
                            @endforeach
            ...
            <div class="card mb-3 widget-content">
                <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-success">{{ $totalRevenue }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3 widget-content">
                <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-danger">{{ $totalSales }}</div>
                        </div>
                    </div>
                </div>
            </div>
