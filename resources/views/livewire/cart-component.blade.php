...
<div class="container">
    ...
    <div class=" main-content-area">
                            ...
                            <div class="summary-item">
                                <form wire:submit.prevent="applyCouponCode">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input id="coupon-code" type="text" name="coupon-code" wire:model="couponCode" />                  
                                    </p>
        ...
        <div class="wrap-iten-in-cart">
            <h4 class="title-box" style="background-color: cadetblue; font-size: 12px; padding: 7px 12px; color: #fff;text-transform: uppercase;">Saved for later</h4>
